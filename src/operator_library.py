...
OPERATOR_ENTRIES: tuple[dict[str, Any], ...] = (
    ...
    _entry(
        name=None, # unique LGLp1 + e^x
        basis=["1", "x", "e^x"],
        quad_basis=["1", "x", "x^2", "e^x", "x e^x", "e^{2x}"],
        op_type="open",
        selector=0,
        interval=(0.0, 1.0),
        nodes=np.array([0.1224183172991507, 0.5237495117358217, 0.8965781844641157]),
        D=np.array([
                        [-3.4817801677732456, 4.5475431376398996, -1.0657629698666542],
                        [-1.3600984289188769, 0.1419784017032722, 1.218120027215605],
                        [1.5398816262344983, -5.8796833923044716, 4.3398017660699733],
                    ]),
        H=np.array([0.2985307764807315, 0.4438168260726194, 0.2576523974466492]),
        tL=np.array([1.4571536639713689, -0.6209063824970495, 0.1637527185256805]),
        tR=np.array([0.2108547518650418, -0.7152269171774729, 1.5043721653124309]),
    ),
    _entry(
        name=None, # unique LGLp1 + e^x
        basis=["1", "x", "e^x"],
        ...
        selector=0,
        interval=(0.0, 1.0),
        nodes=np.array([0.0, 0.2956452973509553, 0.7423537957624353, 1.0]),
        D=np.array([
                        [-5.4655042770508313, 7.3651259588725289, -2.8029010938492944, 0.9032794120275968],
                        [-1.5520030825193016, 0.0, 2.142484823918938, -0.5904817413996366],
                        [0.6430914530941254, -2.3327613870036452, 0.0, 1.6896699339095198],
                        [-1.0922794114415495, 3.3884860974627729, -8.905299858606412, 6.6090931725851885],
                    ]),
        H=np.array([0.0914828668416665, 0.4341375638725624, 0.3987262251819201, 0.0756533441038511]),
        tL=np.array([1.0, 0.0, 0.0, 0.0]),
        tR=np.array([0.0, 0.0, 0.0, 1.0]),
    ),
    _entry(
        ...
        D=np.array([
                        [-2.0245897836465883, 2.6457101870382549, -0.8221177929911391, 0.2009973895994723],
                        [-0.6933668379428749, 0.1029803506438555, 0.7433692278815013, -0.1529827405824819],
                        [0.5025301566367292, -1.7473900039848078, 0.5276067701364315, 0.7172530772116471],
                        [-3.4821275601927626, 10.3663120245496856, -20.9923030391648808, 14.1081185748079569],
                    ]),
        H=np.array([0.2408833006291285, 1.0230257924982096, 0.6533248773711968, 0.0827660295014652]),
        tL=np.array([1.0, 0.0, 0.0, 0.0]),
        tR=np.array([-0.1569084477980503, 0.4590240839633009, -0.8302994982530068, 1.5281838620877561]),
    ),
    _entry(
