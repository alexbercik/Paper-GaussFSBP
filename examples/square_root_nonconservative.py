...
OPEN_SQRT_OPERATOR = OperatorSpec(
    ["1", "x", "x^2", "sqrt(1-x)"],
    ["1", "x", "x^2", "x^3", "x^4", "1/sqrt(1-x)", "x/sqrt(1-x)", "x^2/sqrt(1-x)"],
    "open",
)
HALF_OPEN_RIGHT_SQRT_OPERATOR = OperatorSpec(
    ["1", "sqrt(1-x)", "x", "x^2"],
    ["1", "x", "x^2", "x^3", "1/sqrt(1-x)", "x/sqrt(1-x)", "x^2/sqrt(1-x)"],
    "half-open-right",
)
...
RUNS = [
    ...
    #     "label": "LGp2 LE",
    #     "interior_operator": OPEN_OPERATOR,
    #     "right_operator": OPEN_SQRT_OPERATOR,
    #     "num_right_elements": None, #2,
    #     "x_right_elements": 0.9,
    # },
    {
        "label": "LGLp2/dirSQRTe",
        "interior_operator": "LGLp2",
        "right_operator": HALF_OPEN_RIGHT_SQRT_OPERATOR,
        "num_right_elements": None, #2,
        "x_right_elements": 0.85, #None,
    },
    # {
    #     "label": "LGp2 GE",
    #     "interior_operator": OPEN_SQRT_OPERATOR,
    #     "right_operator": OPEN_SQRT_OPERATOR,
    #     "num_right_elements": 1,
    #     "x_right_elements": None,
    # },
...
plot_convergence(
    ...
    np.vstack(err_rows),
    labels,
    title="Square-root nonconservative problem",
    grid=True,
...
plot_solution_profiles(
    ...
    title=rf"Square-root nonconservative, coarsest mesh ({COARSE_ELEMENTS} elements)",
    grid=True,
)
